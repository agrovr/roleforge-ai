...
test("landing pricing status pills stay readable on dark featured cards", () => {
  ...
  assert.match(stylesheet, /\.price-status\.current\s*\{(?=[^}]*border-color:\s*rgba\(255,\s*250,\s*240,\s*0\.98\))(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffdf8\s*0%,\s*#ffe3a0\s*48%,\s*#d99b3c\s*100%\))(?=[^}]*color:\s*#120903)(?=[^}]*text-shadow:\s*none)[^}]*\}/s);
  assert.match(stylesheet, /\.price-card\.featured\s+\.price-status\.current\s*\{(?=[^}]*border-color:\s*#fffaf0)(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffdf8\s*0%,\s*#ffe3a0\s*48%,\s*#d99b3c\s*100%\))(?=[^}]*color:\s*#0b0601)(?=[^}]*0 0 0 1px rgba\(255,\s*247,\s*233,\s*0\.5\))(?=[^}]*0 0 0 2px rgba\(8,\s*12,\s*24,\s*0\.28\))[^}]*\}/s);
  ...
  assert.match(stylesheet, /html\[data-theme="dark"\]\s+\.price-status\.current\s*\{(?=[^}]*border-color:\s*rgba\(255,\s*250,\s*240,\s*0\.98\))(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffdf8\s*0%,\s*#ffe3a0\s*48%,\s*#d99b3c\s*100%\))(?=[^}]*color:\s*#0b0601)(?=[^}]*0 0 0 1px rgba\(255,\s*247,\s*233,\s*0\.52\))(?=[^}]*text-shadow:\s*none)[^}]*\}/s);
  assert.match(stylesheet, /html\[data-theme="dark"\]\s+\.price-card\.featured\s+\.price-status\.current\s*\{(?=[^}]*border-color:\s*#fffaf0)(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffdf8\s*0%,\s*#ffe3a0\s*48%,\s*#d99b3c\s*100%\))(?=[^}]*color:\s*#080401)(?=[^}]*0 0 0 1px rgba\(255,\s*247,\s*233,\s*0\.68\))(?=[^}]*0 0 0 2px rgba\(8,\s*12,\s*24,\s*0\.34\))[^}]*\}/s);
