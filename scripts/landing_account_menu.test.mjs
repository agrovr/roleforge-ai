...
test("landing pricing status pills stay readable on dark featured cards", () => {
  ...
  assert.match(stylesheet, /\.price-status\.current\s*\{(?=[^}]*border-color:\s*rgba\(112,\s*67,\s*20,\s*0\.66\))(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffaf0\s*0%,\s*#f7d17b\s*100%\))(?=[^}]*color:\s*#211304)[^}]*\}/s);
  assert.match(stylesheet, /\.price-card\.featured\s+\.price-status\.current\s*\{(?=[^}]*border-color:\s*rgba\(255,\s*250,\s*240,\s*0\.96\))(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffaf0\s*0%,\s*#ffd276\s*100%\))(?=[^}]*color:\s*#160c03)(?=[^}]*0 0 0 1px rgba\(23,\s*16,\s*29,\s*0\.18\))[^}]*\}/s);
  assert.match(stylesheet, /html\[data-theme="dark"\]\s+\.price-status\.current\s*\{(?=[^}]*border-color:\s*rgba\(255,\s*250,\s*240,\s*0\.9\))(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffaf0\s*0%,\s*#f7d17b\s*100%\))(?=[^}]*color:\s*#100b05)(?=[^}]*0 0 0 1px rgba\(8,\s*12,\s*24,\s*0\.2\))[^}]*\}/s);
  assert.match(stylesheet, /html\[data-theme="dark"\]\s+\.price-card\.featured\s+\.price-status\.current\s*\{(?=[^}]*border-color:\s*rgba\(255,\s*250,\s*240,\s*0\.98\))(?=[^}]*background:\s*linear-gradient\(135deg,\s*#fffaf0\s*0%,\s*#ffd276\s*100%\))(?=[^}]*color:\s*#0f0902)(?=[^}]*0 0 0 1px rgba\(8,\s*12,\s*24,\s*0\.28\))[^}]*\}/s);
});
