...
async function checkPublicShell(baseUrl) {
  ...
  requireCondition(/\.cta-section\s+\.section-inner\s*\{(?=[^}]*width:\s*min\(1520px\s*,\s*100%\))(?=[^}]*padding-inline:\s*0)[^}]*\}/s.test(stylesheetText), "landing final CTA section still uses unsafe full-bleed padding math");
