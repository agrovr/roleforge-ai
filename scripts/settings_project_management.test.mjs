...
test("settings saved project stage controls are compact and overflow-safe", () => {
  ...
  assert.match(stylesheet, /#projects\s+\.settings-section-panel\s*\{(?=[^}]*inline-size:\s*100%)(?=[^}]*max-inline-size:\s*100%)[^}]*\}/s);
  ...
  assert.match(stylesheet, /\.settings-project-summary\s*\{(?=[^}]*grid-template-columns:\s*minmax\(0,\s*1fr\)\s+auto)(?=[^}]*align-items:\s*start)[^}]*\}/s);
  assert.match(stylesheet, /\.settings-project-controls\s*\{(?=[^}]*justify-self:\s*stretch)(?=[^}]*inline-size:\s*100%)(?=[^}]*grid-template-columns:\s*repeat\(2,\s*minmax\(0,\s*1fr\)\))(?=[^}]*max-width:\s*100%)(?=[^}]*overflow:\s*hidden)(?=[^}]*border-top:\s*1px\s+solid)[^}]*\}/s);
  assert.match(stylesheet, /\.settings-project-controls\s*>\s*\*\s*\{(?=[^}]*min-inline-size:\s*0)(?=[^}]*max-inline-size:\s*100%)[^}]*\}/s);
  ...
  assert.match(stylesheet, /\.settings-project-rename-row\s+button\s*\{(?=[^}]*max-width:\s*100%)(?=[^}]*min-width:\s*0)(?=[^}]*white-space:\s*nowrap)[^}]*\}/s);
  assert.match(stylesheet, /\.settings-project-downloads\s*\{(?=[^}]*display:\s*flex)(?=[^}]*flex-wrap:\s*wrap)(?=[^}]*min-width:\s*0)[^}]*\}/s);
  assert.match(stylesheet, /\.settings-project-downloads\s+\.btn\s*\{(?=[^}]*flex:\s*0\s+1\s+auto)(?=[^}]*width:\s*auto)(?=[^}]*min-width:\s*0)(?=[^}]*max-width:\s*100%)(?=[^}]*white-space:\s*nowrap)[^}]*\}/s);
  assert.match(stylesheet, /\.settings-project-kit\s*\{(?=[^}]*display:\s*grid)(?=[^}]*min-width:\s*0)(?=[^}]*overflow:\s*hidden)[^}]*\}/s);
  assert.match(stylesheet, /\.settings-project-kit-grid\s*\{(?=[^}]*display:\s*grid)(?=[^}]*grid-template-columns:\s*repeat\(auto-fit,\s*minmax\(min\(100%,\s*148px\),\s*1fr\)\))(?=[^}]*min-width:\s*0)[^}]*\}/s);
