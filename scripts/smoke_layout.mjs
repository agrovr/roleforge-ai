...
const PAGE_CHECKS = [
  ...
  },
  {
    path: "/help",
    name: "help",
    selectors: [".legal-shell", ".legal-topbar", ".legal-hero", ".help-quick-grid", ".legal-grid", ".legal-card", ".legal-footer-card"],
    textFitSelectors: [
      ".legal-hero h1",
      ".legal-hero p",
  ...
  },
  {
    path: "/support",
    name: "support",
    selectors: [".legal-shell", ".legal-topbar", ".legal-hero", ".support-layout", ".support-guide-card", ".support-request-card", ".legal-footer-card"],
    textFitSelectors: [
      ".legal-hero h1",
      ".legal-hero p",
      ".legal-hero-card span",
  ...
  },
  {
    path: "/updates",
    name: "updates",
    selectors: [".legal-shell", ".legal-topbar", ".legal-hero", ".updates-timeline", ".updates-card", ".legal-footer-card"],
    textFitSelectors: [
      ".legal-hero h1",
      ".legal-hero p",
      ".legal-hero-card span",
